...
- (IBAction) dismissPreferenceWindow:(id)sender {
	[defaults setObject:[googleAPIKey stringValue] forKey:@"googleAPIKey"];
	[defaults setObject:[jqueryVersion stringValue] forKey:@"jqueryVersion"];
	[defaults setObject:[jqueryUIVersion stringValue] forKey:@"jqueryUIVersion"];
...
- (void)	 setApplicationDefaults {
	NSLog(@"%s- [%04d] %@", __PRETTY_FUNCTION__, __LINE__, @"");
	NSDictionary *appDefaults = [NSDictionary dictionaryWithObject:@"ABQIAAAAGRbKDdWDinpZa8yW9ygJUBSQx1erA_pbq2SnEAbgryMectdTkxRq0qdLXP2ae-iTc4DRxb2yDa62kg" forKey:@"googleAPIKey"];
    [[NSUserDefaults standardUserDefaults] registerDefaults:appDefaults];
	[[NSUserDefaults standardUserDefaults] setPersistentDomain:appDefaults forName:@"ca.roaringsky.Trixie"];
